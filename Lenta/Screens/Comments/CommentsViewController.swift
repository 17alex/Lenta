...
final class CommentsViewController: UIViewController {
    ...
    private func subscribeKboardNotofication() {
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(willShowKboard(notification:)),
                                               name: UIResponder.keyboardWillShowNotification,
                                               object: nil)
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(willHideKboard(notification:)),
    ...
    @objc private func willShowKboard(notification: NSNotification) {
        ...
        UIView.animate(withDuration: animDuration) {
            ...
            if countRow != 0 {
                self.commentsTableView.scrollToRow(at: IndexPath(row: countRow - 1, section: 1),
    ...
    private func setupUI() {
        ...
        newCommentTextViewHeight =
            newCommentTextView.heightAnchor.constraint(equalToConstant: newCommentTextViewHeightDefaultConstant)
        newCommentTextViewHeight?.isActive = true

        babbleViewBottom = cardView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor,
                                                            constant: babbleViewBottomDefaultConstant)
